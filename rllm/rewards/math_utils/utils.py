...
def are_equal_under_sympy(ground_truth: str, given: str, timeout: int = 10):
    try:
        payload = json.dumps({"gt": ground_truth, "pred": given})
        script_dir = os.path.dirname(os.path.abspath(__file__))
        worker_path = os.path.join(script_dir, "sympy_worker.py")
